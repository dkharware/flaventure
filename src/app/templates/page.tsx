...
const templates: Template[] = [
  ...
  { id: 'bold', name: 'Bold', category: 'Creative', imageUrl: '/images/templates/creative.png', hint: 'resume bold', isPremium: true, price: 50, color: 'red' },
  { id: 'classic', name: 'Classic', category: 'Corporate', imageUrl: '/images/templates/professional.png', hint: 'resume classic', color: 'blue' },

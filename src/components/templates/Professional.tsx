...
export function ProfessionalTemplate() {
  ...
  return (
    <div className="p-8 bg-white text-gray-800 font-sans text-[10px] leading-snug grid grid-cols-3 gap-8">
      {/* Left Column */}
      <div className="col-span-1 space-y-6">
        <div>
          <h1 className="text-3xl font-bold font-serif text-primary tracking-tighter">{personalInfo.name}</h1>
          <h2 className="text-sm font-semibold text-gray-600">{personalInfo.title}</h2>
        </div>

        <div>
          <h3 className="text-sm font-bold text-primary border-b border-gray-200 pb-1 mb-2 tracking-wider">CONTACT</h3>
        ...
        <div>
          <h3 className="text-sm font-bold text-primary border-b border-gray-200 pb-1 mb-2 tracking-wider">SKILLS</h3>

  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="space-y-4">
        <div className={cn(currentStepId !== 'personal-info' && 'hidden')}><PersonalInfoForm /></div>
        <div className={cn(currentStepId !== 'summary' && 'hidden')}><SummaryForm /></div>
        <div className={cn(currentStepId !== 'experience' && 'hidden')}><ExperienceForm /></div>
        <div className={cn(currentStepId !== 'education' && 'hidden')}><EducationForm /></div>
        <div className={cn(currentStepId !== 'skills' && 'hidden')}><SkillsForm /></div>
        <div className={cn(currentStepId !== 'hobbies' && 'hidden')}><HobbiesForm /></div>
      </div>

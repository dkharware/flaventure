...
export function WhatsappBanner() {
  ...
  return (
    <div
      className={cn(
        'relative z-50 bg-green-600 text-white transition-transform duration-500',
    ...
    >
      <div className="container mx-auto flex items-center justify-center gap-4 p-3 text-center">
        ...
        <Button onClick={handleDismiss} variant="ghost" size="icon" className="absolute top-1/2 right-2 -translate-y-1/2 h-8 w-8 hover:bg-green-700">
            <X className="h-5 w-5" />
